        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiverId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: true),
                    ReceiverName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ApproverId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: true),
